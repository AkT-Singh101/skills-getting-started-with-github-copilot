...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice teamwork, endurance, and competitive soccer skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Train for swimming meets and improve aquatic fitness",
    ...
    "Debate Team": {
        "description": "Practice critical thinking, public speaking, and persuasive argumentation",
